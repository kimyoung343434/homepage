...
<div class="container">
  ...
  <label class="col-sm-offset-2 col-sm-10">(<span id="need">*</span> 필수입력사항)</label>
	  ...
	  >
		...
		<button type="button" class="btn btn-default col-sm-2"
		onclick="telCheck(document.frm.tel.value)">전화번호 중복확인</button>
		<div id="telcheck"></div>
		</div>
		...
		<div class="form-group">
		<label class="control-label col-sm-2" for="repasswd"><span id="need">*</span>비밀번호확인:</label>
		<div class="col-sm-6">
